    ...
    <div className={styles.aboutContainer}>
      ...
      <div className={styles.section}>
        ...
        <p className={styles.sectionText}>
          ...
          <ul>
            <li>Student Robotics Teams — helping schools and community groups start and sustain robotics programs.</li>
            <li>Competitions & Events — creating inspiring spaces for students to learn, collaborate, and compete.</li>
            <li>Training & Mentorship — empowering coaches, educators, and volunteers who guide the next generation of innovators.</li>
          </ul>
